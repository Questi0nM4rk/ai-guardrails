...
const FIXTURE_PATH = new URL("../fixtures/pyright-output.json", import.meta.url).pathname;
...
describe("pyrightRunner", () => {
  ...
  test("generateConfig returns pyrightconfig.json template", () => {
    const config = pyrightRunner.generateConfig(makeConfig());
